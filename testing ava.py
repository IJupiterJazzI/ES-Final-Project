...
while True:
    if stage == 0:
        ...
        upCorrAvg = (
                                upCorr1 + upCorr2 + upCorr3 + upCorr3 + upCorr4 + upCorr5 + upCorr6 + upCorr7 + upCorr8 + upCorr9 + upCorr10) / 10
        ...
        downCorrAvg = (
                                  downCorr1 + downCorr2 + downCorr3 + downCorr3 + downCorr4 + downCorr5 + downCorr6 + downCorr7 + downCorr8 + downCorr9 + downCorr10) / 10
        ...
        leftCorrAvg = (
                                  leftCorr1 + leftCorr2 + leftCorr3 + leftCorr3 + leftCorr4 + leftCorr5 + leftCorr6 + leftCorr7 + leftCorr8 + leftCorr9 + leftCorr10) / 10
        ...
        # Chooses whichever correlation number is the largest, above a
        # certain value, and then sends that command to the website.
